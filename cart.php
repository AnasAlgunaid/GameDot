          ...
          <div class="col-span-12  lg:pr-8 py-4 w-full max-xl:max-w-3xl max-xl:mx-auto">
            ...
            <div class="flex flex-col min-[500px]:flex-row min-[500px]:items-center gap-5 py-6  border-b border-secondaryBlack ">
              <div class="w-full md:max-w-[126px]">
                <img src="./src/images/thelastofus.png" alt="The Last of US" class="mx-auto rounded-md">
              </div>
              <div class="grid grid-cols-1 md:grid-cols-4 w-full">
                <div class="md:col-span-2">
                  <div class="flex flex-col max-[500px]:items-center gap-1 md:gap-2">
                    <h6 class="font-semibold text-xl leading-7 text-white">The Last of Us</h6>
                    <h6 class="font-normal text-base leading-7 text-gray-500">PS4</h6>
                    <h6 class="font-medium text-base leading-7 text-primary transition-all">$120.00</h6>
                  </div>
                </div>
                <div class="flex items-center max-[500px]:justify-center h-full max-md:mt-3">
                  <div class="flex items-center h-full">
                    ...
                    <input type="text" class="border-y border-gray-700 outline-none text-white font-semibold text-lg w-full max-w-[73px] min-w-[60px] placeholder:text-gray-600 py-[15px]  text-center bg-transparent" value="1">
                ...
                <div class="flex items-center max-[500px]:justify-center md:justify-end max-md:mt-3 h-full">
                  <p class="font-bold text-lg leading-8 text-primary text-center transition-all duration-300 ">$120.00</p>
                </div>
              </div>
            </div>
            <!-- End of Product -->
            ...
            <div>
              <form>
                <div class="flex items-center justify-between py-8">
                  <p class="font-medium text-xl leading-8 text-white">3 Items</p>
